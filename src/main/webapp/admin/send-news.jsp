			...
			<div class="grid-demo grid-demo-bg1">
				...
				<form class="layui-form" action="sendNews" method="post" enctype="multipart/form-data">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="type" lay-verify="type"
								autocomplete="off" placeholder="请输入文章类型" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea placeholder="文章内容" name="content" class="layui-textarea" id="htmlbox_icon_set_green"></textarea>
			...
			<form class="layui-form" action="">
				...
				<div class="layui-form-item">
					<label for="s_age" class="layui-form-label"> <span
						class="x-red">*</span>文章内容
					</label>
					<div class="layui-input-inline">
						<textarea placeholder="文章内容" class="layui-textarea"></textarea>
					</div>
				</div>
				<div class="layui-form-item">
					<label for="L_pass" class="layui-form-label"> <span
						class="x-red">*</span>文章作者
					</label>
					<div class="layui-input-inline">
