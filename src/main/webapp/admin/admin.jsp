...
<meta charset="utf-8">
<title>校史馆后台管理系统</title>
</head>
<body class="index">
	<!-- 顶部开始 -->
	<div class="container">
		<div class="logo">
			<a href="./index.html">校史馆后台管理系统</a>
		</div>
		<div class="left_open">
		...
		<ul class="layui-nav right" lay-filter="">
			...
			<li class="layui-nav-item to-index"><a href="../history/main">校史馆网页首页</a></li>
		</ul>
	</div>
	<!-- 顶部结束 -->
	<!-- 中部开始 -->
	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
				...
				<li><a href="javascript:;"> <i class="iconfont left-nav-li"
						lay-tips="文章管理">&#xe723;</i> <cite>文章管理</cite> <i
						class="iconfont nav_right">&#xe697;</i></a>
					<ul class="sub-menu">
						<li><a onclick="xadmin.add_tab('文章列表','news-list')">
								<i class="iconfont">&#xe6a7;</i> <cite>文章列表</cite>
						</a></li>
					</ul>
					<ul class="sub-menu">
						<li><a onclick="xadmin.add_tab('文章发布','send-news.jsp')">
								<i class="iconfont">&#xe6a7;</i> <cite>文章发布</cite>
						</a></li>
					</ul>
					<ul class="sub-menu">
						<li><a onclick="xadmin.add_tab('文章修改','news-change')">
								<i class="iconfont">&#xe6a7;</i> <cite>文章修改</cite>
						</a></li>
					</ul>
