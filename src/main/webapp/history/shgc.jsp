...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath() %>/css/shgc.css">
...
<body>
    ...
    <div class="navigation">
		<ul class="layui-nav layui-bg-cyan">
			...
			<li class="layui-nav-item layui-this"><a href="<%=request.getContextPath() %>/history/shgc">史海钩沉</a></li>
	...
	<div class="content">
		...
		<div class="shgc_news">
			<div class="web_adress">当前位置：<a href="index.jsp">首页</a>|<a href="">史海钩沉</a></div>
			<div class="news_title">
				<span>史海钩沉</span><img src="<%=request.getContextPath() %>/img/history.png" alt="">
				<hr class="style-one"/>
			</div>
			<div class="news_list">
				<ul class="news_list_content">
					<c:forEach items="${shgcList}" var="shgc">
					<li>
						<a href="new?id=${shgc.id}" target="_blank">
							<span class="list_title">${shgc.title}</span>
							<span class="list_time">${shgc.date}</span>
						</a>
					</li>
					</c:forEach>
				</ul>
