 ...
 * 加载首页的文章
 */
@WebServlet("/history/gzdt")
public class ShowGzdtServlet extends HttpServlet {
...
//		News allNews = new News();
        ...
        int pre = pageindex - 1;
        int total = new PageDAO().GzdtTotal();
        int last;
...
//		System.out.println(newList.toString()); 
		...
		request.getRequestDispatcher("gzdt.jsp").forward(request, response);
	}
}
